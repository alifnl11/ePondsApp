...
export default class ProfilePekerja extends React.Component {
  state = {
    email: "",
    displayName: "",
    ancuList: [],
      ...
      <View style={styles.container}>
        <View style={styles.content}>
          ...
          <View style={styles.rowBtn}>
            ...
            <MaterialCommunityIcons name="folder-plus" style={styles.logoutLogo}  size={35}/>
            <Text style={styles.historiText}>History Ancu</Text>
            </TouchableOpacity>
            </View>
            <View style={styles.btnLogout}>
            <TouchableOpacity onPress={this.signOutUser}>
