...
export default class LoginPekerja extends React.Component {
  ...
  handleLogin = () => {
    ...
    .then(this.props.navigation.navigate("LoadingPekerja"))
    ...
    return (
      <ImageBackground source={bgImage} style={styles.backgroundContainer}>
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.logoText}>Login Pekerja</Text>
        </View>
