      ...
      <View style={styles.container}>
        <Header />
          <View style={styles.content}>
            {/* Content 1 */}
            <Text style={styles.tittlecontent}>Pond's Summary</Text>
              {/* Isi content 1 */}
              <View style={styles.maincontent}>
                <Text style={styles.textcontent}>Lihat Semua ></Text>
                {/* Kotak kiri */}
                <View style={styles.boxContainer}>
                  <View style={styles.box}>
                    <Text style={styles.textBox}>Total Kolam</Text>
                    <Text style={styles.numberBox}>10</Text>
                  </View>
                  {/* Kotak tengah */}
                  <View style={styles.box}>
                    <Text style={styles.textBox}>Total Udang</Text>
                    <Text style={styles.numberBox}>547.000</Text>
                  </View>
                  {/* Kotak kanan */}
                  <View style={styles.box}>
                    <Text style={styles.textBox}>Kualitas Air</Text>
                    <Text style={styles.numberBox}>Baik</Text>
                  </View>
                </View>
              </View>
                {/* Content 2 */}
